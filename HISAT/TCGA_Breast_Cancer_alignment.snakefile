...
SAM_AL_DIR = "/data/storage/SAYRES/Isoforms_Breast_Prostate/Data/Prostate/GRCh38_SAM/" # path to directory for SAM alignment files
BAM_AL_DIR = "/data/storage/SAYRES/Isoforms_Breast_Prostate/Data/Prostate/GRCh38_BAM/" # path to directory for BAM alignment files
SORTED_BAM_AL_DIR = "/data/storage/SAYRES/Isoforms_Breast_Prostate/Data/Prostate/GRCh38_sorted_BAM/" # path to directory for sorted BAM alignment files
FEATURECOUNTS_DIR = "/data/storage/SAYRES/Isoforms_Breast_Prostate/Data/Prostate/GRCh38_featurecounts/" # path to directory for FeatureCounts gene count files
