...
# Directories
FQ_DIR = "/data/storage/SAYRES/Isoforms_Breast_Prostate/Data/Breast/trimmed_fastqc/" # path to directory with fastq files
SAM_AL_DIR = "/data/storage/SAYRES/Isoforms_Breast_Prostate/Data/Breast/GRCh38_SAM_dta/" # path to directory for SAM alignment files
BAM_AL_DIR = "/data/storage/SAYRES/Isoforms_Breast_Prostate/Data/Breast/GRCh38_BAM_dta/" # path to directory for BAM alignment files
SORTED_BAM_AL_DIR = "/data/storage/SAYRES/Isoforms_Breast_Prostate/Data/Breast/GRCh38_sorted_BAM_dta/" # path to directory for sorted BAM alignment files
FEATURECOUNTS_DIR = "/data/storage/SAYRES/Isoforms_Breast_Prostate/Data/Breast/GRCh38_featurecounts_dta/" # path to directory for FeatureCounts gene count files
